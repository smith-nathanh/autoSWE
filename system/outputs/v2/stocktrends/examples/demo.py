...
renko_data = calculator.calculate_renko(preprocessed_data, brick_size=2, chart_type='PERIOD_CLOSE')
line_break_data = calculator.calculate_line_break(preprocessed_data, line_number=3)
